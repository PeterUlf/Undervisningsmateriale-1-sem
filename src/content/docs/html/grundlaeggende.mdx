...
HTML har seks niveauer af overskrifter, fra `<h1>` (højeste niveau) til `<h6>` (laveste niveau). Niveauet beskriver indholdets struktur, ikke hvor stor teksten skal se ud:

```html
<h1>Sidens hovedoverskrift</h1>
<h2>Overskrift på niveau 2</h2>
<h3>Overskrift på niveau 3</h3>
<h4>Overskrift på niveau 4</h4>
<h5>Overskrift på niveau 5</h5>
<h6>Overskrift på niveau 6</h6>
```

:::tip[God praksis]
Brug som udgangspunkt én `<h1>` per side, og brug CSS til at styre overskrifternes størrelse.
:::
...
:::tip[God praksis]
Brug som udgangspunkt én `<h1>` pr. side. Det er sidens hovedoverskrift.
:::
