---
title: API querystring opgaver
description: Intro + en samlet kodeboks med alle 20 opgaver
sidebar:
  label: API querystring opgaver
  order: 4.15
  badge:
    text: Tema 8
    variant: tip
...
På næste slide får du én stor kodeboks med alle 20 opgaver.

Sådan bruger du den i CodePen:

1. Kopier hele boksen.
2. Udfyld `urlParametre` i den opgave du vil løse.
3. Kald funktionen i bunden, fx `opgave1();`.
4. Løs én opgave ad gangen.

Når du bruger flere query-parametre i samme URL, skal de adskilles med `&`.
<span style="color: #b30000;">Eksempel: <code>...?limit=12&amp;start=0</code></span>

</Slide>
<div class="page-break"></div>
<Slide>

## En samlet boks med alle 20 opgaver
